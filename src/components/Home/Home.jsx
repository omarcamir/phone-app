  ...
  return (
    <div className="home">
      ...
      <div className="col-sm-12 col-md-6">
        ...
        <div className="btn__content d-flex justify-content-evenly align-items-center w-md-75 py-5">
          <button className='btn btn-warning text-capitalize w-50'><Link to='../shop' className='page-link'>go to shop</Link></button>
